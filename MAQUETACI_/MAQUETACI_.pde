...
//Enumerat pantalles
enum PANTALLA {ENTRADA, IS, EMP, ELECCION,FAQs,  ESENCIALES, PRACTICA, PRACTICATEST1, PRACTICATEST2, EVALUACION, CORRECCION};

//PANTALLA ACTUAL
PANTALLA pantalla=PANTALLA.PRACTICATEST2;
